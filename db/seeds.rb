...
Article.create(:allow_comments => true, :allow_pings => true, :author => "Mr Typo", :body => "yolo", :guid => "1bf3e2ca-ed7b-4562-8a4a-8ce8438822c8", 
				:id => 1, :permalink => "hello-world", :post_type => "read", :published => true, :published_at => "2012-06-09 21:51:55 UTC", 
				:settings => {"password"=>""}, :state => "published", :text_filter_id => 5, :title => "Hello World!", 
				:type => "Article", :user_id => 1).comments.create(author: 'yolo_commentor', body: 'yolo_content')
